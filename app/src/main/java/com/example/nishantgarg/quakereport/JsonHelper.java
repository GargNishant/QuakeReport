...
/**
 * Created by Nishant Garg on 05-12-2017.
 */

public class JsonHelper {

    private static final String LOG_TAG = JsonHelper.class.getSimpleName();
    //We are constructing a private constructor to avoid accidental call from outside the class
    private JsonHelper(){}

    static String extractEarthQuakes(String urlString){
        URL url =createURL(urlString);
        String jsonResponse=null;
        try{
            jsonResponse=makeHttpRequest(url);
        }
        catch (Exception e){Log.e(LOG_TAG, "Problem making the Http Request:  ", e);}
    ...
    private static String readFromStream(InputStream inputStream) throws Exception {
     ...
     static List<Quakes> extractFeatureFromJson(String earthquakeJSON) {
